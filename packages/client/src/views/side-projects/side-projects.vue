...
export default {
  data: () => ({
    sideProjects: [
      ...
      { title: 'Tic Tac Toe', icon: 'mdi-alpha-x-box-outline', disabled: true, path: '', img: 'ttt.jpg', internal: true, desc: `The classic Tic Tac Toe -- now Digital (as if it wasn't already.) Take turns with a pal and show them how to win!` },
